...
class BinaryDependencyGraph:
    def __init__(self, fw_path, seed_bins, h_keywords=None, plugins=(), logger_obj=None, ignore_bins=None):
        """
            ...
            if b not in self._projects:
                ...
                try:
                    try:
                        ...
                        log.info("We got a blob! Ignoring it in this eval")
                        continue
    ...
    def _find_role(self, s=None, things=None):
        ...
        if s:
            ...
            print "Blobs not considered in this evaluation."
